...
I developed the methodology workflow and file organization schema for the validation process. However, because the imagery was of reduced quality due to conditions on the day of the drone flight, we were not completely confident of the results.

## Grid Classification

Another GIS project I completed at SONGS MMP was converting raw vegetative coverage results from the aforementioned remote sensing company into a gridded format used by the principle investigators to determine whether project standards were met. The results are shown in figure 3.
...
Another task at SONGS MMP was mapping project assets, such as air and water quality loggers, using RTK GPS. In addition, I created maps used in project presentations for the scientific advisory panel and the public. Figure 4 shows one example.
